...
const InlineCss = () => {
    ...
    return (
        <div>
            ...
            {/* (3-3) public 폴더에 있는 파일들은 단순 절대경로로 참조 가능함 (public 폴더 하위에 임의의 폴더 생성 가능) */}
            <img src='/public/basic/_05_styleSheet/img/sample.png' width='240' height='240' alt='react' />
        </div>
    );
};
